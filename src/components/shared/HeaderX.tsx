...
const HeaderX = ({ isMain }: HeaderProps) => {
    ...
    <>
      <nav className="flex-wrap lg:flex items-center bg-transparent">
        <div className="flex items-center mb-10 lg:mb-0">
          ...
          <div className="lg:text-3xl md:text-2xl text-xl font-bold text-white">
            HOH Engine Oil
          </div>
          <button
        ...
        >
          <li className="font-semibold text-white hover:text-gray-400 transition ease-in-out duration-300 mb-5 lg:mb-0">
            <Link to="/">Home</Link>
          </li>
          <li className="font-semibold text-white hover:text-gray-400 transition ease-in-out duration-300 mb-5 lg:mb-0">
