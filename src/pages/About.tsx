    ...
    <>
      <div className="flex flex-col container max-w-screen-xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 mt-10">
          <div className="text-white flex flex-col w-full justify-center rounded-lg border-white border-2">
          ...
          <div className="text-white flex flex-col w-full justify-center  rounded-lg shadow-lg border-white border-2">
            <div className="flex w-full justify-center pt-[10%]">
              <div className="flex items-center text-3xl text-start font-bold">
                <div className="flex w-16 bg-red-400 h-1 mr-3"></div>
                Our Vision
