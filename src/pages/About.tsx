            ...
            <div className="text-white flex flex-col w-full justify-center rounded-lg border-[#D7B867] border-2 py-[5%]">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:px-10 px-6">
                <div className="flex flex-col gap-4 md:pl-4 pt-2 text-[#D7B867] text-3xl">
                  <div className="text-[40px]">HOH®</div>
                  <div className="text-white font-[46px]">
                    DELIVERING GOLD PERFORMANCE
                  </div>
                </div>
                <div className="flex text-[20px] leading-8 tracking-wide">
                  HOH LUBRICANT® Gold Performance is a leading name in the
                  lubricant Industry.It offers a wide range of lubricants and grease products that
                  caters to the demand of automotive, industrial, agricultural,
                  transport, and mining sectors. 
                </div>
                <div className="flex text-[20px] leading-8 tracking-wide">
                  Building on an experience
                  spanning over two decades and research at our own
                  laboratories, our team of qualified petroleum engineers work
                  proactively to meet consumer needs and deliver quality
        ...
        <div className="flex w-full">
          <section className="bg-[#BD8C3B] w-full py-16">
            <div className="flex flex-col w-full mb-16 gap-2">
              <div className="flex w-full justify-center">
                <div className="text-2xl text-white text-[26px] uppercase">
                  Our Values
                </div>
              </div>
              <div className="flex w-full justify-center">
